    ...
    >
      ...
      >
        ...
        <Stack rowGap={"1rem"} padding={"1rem"}>
          ...
          <Typography sx={labelStyles}>support@shoplane.com</Typography>
          <Typography sx={labelStyles}>+1 (555) 123-4567</Typography>
        </Stack>
      ...
      <Stack alignSelf={"center"}>
        <Typography color={"GrayText"}>
          &copy; SHOPLANE {new Date().getFullYear()}. All right reserved
        </Typography>
      </Stack>
    </Stack>
  );
